...
| tok_nova_namespace tok_identifier
    {
      pwarning(1, "'nova_namespace' is deprecated. Use 'namespace nova' instead");
      pdebug("Header -> tok_nova_namespace tok_identifier");
      declare_valid_program_doctext();
      if (g_parse_mode == PROGRAM) {
        g_program->set_namespace("nova", $2);
      }
    }
